...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td rowspan="8" colspan="2" style="border-left:1px solid black;" background-image="images/print-logo.jpg"><img src="images/print-logo.jpg" alt="logo" width="250px;"></td>
                  ...
                  <tr>
                     <td colspan="3" style=" text-align: right;">The Warehouse Pvt. Ltd , &nbsp;</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Shop No 13, Ashok Nagar East, Surat, GJ 400059 &nbsp;</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Tele: 7620361772, 7378339922 &nbsp;</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align:right;"></td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;color: black;"> Email: thewarehousepvtltd@email.co.in &nbsp;</td>
                  </tr>
                  <tr>
                     ...
                     <td style="padding: 0px;vertical-align: top;" colspan="3">
                        <table align="left" cellpadding="0" cellspacing="0" style="width: 100%">
                           <tbody>
                              ...
                              <tr>
                                 <td style="border-bottom-style: solid;border-bottom-width: thin;border-bottom-color: black;height: 52px;border-right: 1px solid black;    color: red;">&nbsp;G.S.T.IN: '.$gstn.'</td>
                              </tr>
                           </tbody>
                        </table>
                     </td>
            ...
            $x++;
                ...
                $table.= '
                  ...
                  <tr>
                     <td colspan="3" style="border-top: 1px solid black;border-bottom: 1px solid white; border-left: 1px solid black;padding: 5px;"></td>
                  ...
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid white;width: 859px;border-left: 1px solid black;padding: 5px;"></td>
                  </tr>
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid white;border-left: 1px solid black;padding: 5px;"></td>
                  ...
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;border-bottom: 1px solid white;padding: 5px;border-right: 1px solid black;"></td>
                     <td rowspan="2" colspan="2" style="vertical-align: bottom;padding: 5px;color: red;border-right: 1px solid black;text-align: center;"> The Warehouse Pvt. Ltd</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;padding-left: 5px;border-right: 1px solid black;">* Intrest will be charged upon all acounts remaning unpaid after due date. *
                     </td>
                  </tr>
               </tbody>
            </table>';
